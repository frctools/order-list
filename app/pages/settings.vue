                  ...
                  <div>
                    ...
                    <div v-else-if="sessions.length > 0" class="space-y-2 mb-4">
                      <div
                        ...
                        :class="{ 'bg-primary-50 dark:bg-primary-900/20 border-primary-200 dark:border-primary-800': sessionItem.token === auth.session.value?.token }"
                      >
                        <div class="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p class="text-xs text-gray-500">
                              ...
                              Last active {{ formatDate(sessionItem.updatedAt) }}
                            </p>
                          </div>
                        </div>
                        <UButton
                    ...
                    <div v-else class="text-center py-4 mb-4 text-sm text-gray-500">
        ...
        <template #content>
          <UCard>
            ...
            <div class="space-y-4">
              ...
              <p v-if="deleteAccountError" class="text-sm text-red-600 dark:text-red-400">
                {{ deleteAccountError }}
              </p>
