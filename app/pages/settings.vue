<template>
  ...
  >
    ...
    <UTabs
      :items="settingsTabs"
      class="mx-auto w-full lg:max-w-3xl"
    >
        ...
        <div class="space-y-6">
          ...
          <UCard>
            ...
            <div class="space-y-4">
              <div>
                <label
                  class="block text-sm font-medium text-toned mb-2"
                >
                  Password
                </label>
                <UButton
              ...
              <div>
                <h3
                  class="text-sm font-medium text-highlighted mb-2"
                >
                  Active sessions
                </h3>
                ...
                <div
                  v-else
                  class="text-center py-4 mb-4 text-sm text-muted"
                >
          ...
          <UCard>
            ...
            <div class="space-y-4">
              <div
                class="p-4 rounded-lg border border-error/30 bg-error/5"
              >
                <h3
                  class="text-sm font-medium text-error mb-1"
                >
                  Delete account
                </h3>
          ...
          <UCard>
            ...
            <div v-else-if="logs.length > 0" class="space-y-2">
              <div
                v-for="log in logs"
                :key="log.id"
                class="flex items-start justify-between p-3 rounded-lg border border-default"
              >
            ...
            <div v-else class="text-center py-8">
              <UIcon
                name="i-lucide-inbox"
                class="w-8 h-8 text-dimmed mx-auto mb-2"
              />
              <p class="text-sm text-muted">No notifications sent yet</p>
            </div>
          </UCard>
        </div>
      </template>
    ...
    <UModal v-model:open="showDeleteAccountModal">
      <template #content>
        <UCard>
          ...
          <div class="space-y-4">
            <div
              class="p-4 rounded-lg bg-error/5 border border-error/30"
            >
